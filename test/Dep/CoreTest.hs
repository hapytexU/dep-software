...
testFunctorLaws = describe "Functor laws" do
  describe (instanceText "Functor" (undefined :: f a)) do
  ...
  describe (instanceText "Functor" (undefined :: f b)) do
  ...
  describe (instanceText "Functor" (undefined :: f c)) do
...
testApplicativeLaws = describe "Applicative laws" do
  describe (instanceText "Applicative" (undefined :: f a)) do
  ...
  describe (instanceText "Applicative" (undefined :: f b)) do
  ...
  describe (instanceText "Applicative" (undefined :: f c)) do
...
testMonadLaws = describe "Monad laws" do
  describe (instanceText "Monad" (undefined :: f a)) do
  ...
  describe (instanceText "Monad" (undefined :: f b)) do
  ...
  describe (instanceText "Monad" (undefined :: f c)) do
...
testSemigroupLaws = describe "Semigroup laws" do
  describe (instanceText "Semigroup" (undefined :: s)) $
...
testMonoidLaws = describe "Monoid laws" do
  describe (instanceText "Monoid" (undefined :: m)) $ do
